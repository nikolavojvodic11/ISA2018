...
import { PlaneTicketsCoreModule } from 'app/core';
import { PlaneTicketsAppRoutingModule } from './app-routing.module';
...
export class PlaneTicketsAppModule {
