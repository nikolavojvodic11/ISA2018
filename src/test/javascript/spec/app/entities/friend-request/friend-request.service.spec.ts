...
import { IFriendRequest, FriendRequest } from 'app/shared/model/friend-request.model';
...
describe('Service Tests', () => {
    describe('FriendRequest Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a FriendRequest', async () => {
            ...
            it('should delete a FriendRequest', async () => {
